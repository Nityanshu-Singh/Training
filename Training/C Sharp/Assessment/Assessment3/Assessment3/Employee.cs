...
namespace Assessment3
{
    ...
    class Program
    {
        static void Main()
        {
            // Create and populate the generic list
            List<Employee> empList = new List<Employee>()
        {
            ...
            // Display detail of all the employees
            ...
            {
                Console.Write($"EmployeeID: {emp.EmployeeID}, Name: {emp.FirstName} {emp.LastName}, Title: {emp.Title}, DOB: {emp.DOB.ToShortDateString()}, DOJ: {emp.DOJ.ToShortDateString()}, City: {emp.City}");
